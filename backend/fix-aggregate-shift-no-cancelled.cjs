...
async function fix() {
  ...
  try {
    ...
    console.log('📋 Changes:');
    console.log('  - CHỈ tính đơn có trang_thai = \'PAID\'');
    console.log('  - KHÔNG tính đơn CANCELLED vào doanh thu\n');
    
    // Test với shift #47
    console.log('🧪 Testing với shift #47...');
    ...
    console.log('🎉 Done! Tab "Tổng quan" giờ sẽ không tính đơn CANCELLED.\n');
