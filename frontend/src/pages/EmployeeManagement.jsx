      ...
      <div className="pb-32">
        ...
        {!selectedEmployee ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="w-[70px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Mã NV</th>
                    <th className="w-[140px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Họ tên</th>
                    <th className="w-[110px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Username</th>
                    <th className="w-[180px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
                    <th className="w-[110px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Số ĐT</th>
                    <th className="w-[90px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Vai trò</th>
                    <th className="w-[100px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Trạng thái</th>
                    <th className="w-[100px] px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ngày tạo</th>
                    <th className="w-[90px] px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Thao tác</th>
                  </tr>
                </thead>
                  ...
                  {loading ? (
                    ...
                    paginatedEmployees.map((emp) => (
                      <tr key={emp.user_id} className="hover:bg-gray-50">
                        ...
                        <td className="px-3 py-3 text-sm text-gray-900 truncate" title={emp.full_name}>
                          {emp.full_name}
                        </td>
                        <td className="px-3 py-3 text-sm text-gray-600 truncate" title={emp.username}>
                          {emp.username}
                        </td>
                        <td className="px-3 py-3 text-sm text-gray-600 truncate" title={emp.email || '-'}>
                          {emp.email || '-'}
                        </td>
                        ...
                        <td className="px-3 py-3 text-sm">
                          <div className="flex flex-wrap gap-1">
                            {emp.roles?.map((role, idx) => (
                              <span
                                key={idx}
                                className={`px-2 py-0.5 text-xs font-semibold rounded-full ${getRoleBadge(role.role_name)}`}
                              >
                                {role.role_name}
                              </span>
                            ))}
              ...
              {totalPages > 1 && (
                <div className="flex gap-1">
                  <button
                    ...
                    className="px-3 py-1.5 border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-white hover:border-[#c9975b] transition-colors text-sm"
                  >
                    ← Trước
                  </button>
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 border rounded-lg text-sm font-medium transition-colors ${
                        currentPage === page
                          ...
                          : 'border-gray-300 hover:bg-white hover:border-[#c9975b]'
                      }`}
                    >
                      {page}
                    </button>
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-[#c9975b] rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#c9975b] text-white border-2 border-[#c9975b] rounded-lg hover:bg-white hover:text-[#c9975b] transition-all duration-200 flex items-center gap-2 font-semibold shadow-md"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 px-6 py-4 font-medium text-sm transition-all duration-200 flex items-center justify-center gap-2 border-b-2 ${
                      detailTab === tab.id
                        ? 'bg-[#c9975b] text-white border-[#c9975b] rounded-t-lg'
