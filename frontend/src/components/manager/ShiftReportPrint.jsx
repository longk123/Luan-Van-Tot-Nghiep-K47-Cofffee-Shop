  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white">
      ...
      <div className="text-center border-b-2 border-gray-300 pb-4 mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">Địa chỉ: 123 Đường 3/2, Phường Xuân Khánh, Ninh Kiều, Cần Thơ</p>
        <p className="text-sm text-gray-600">Điện thoại: 0292 388 888</p>
