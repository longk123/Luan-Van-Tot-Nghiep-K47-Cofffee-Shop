...
export default function ReservationsList({ open, onClose, onCheckIn, onReservationUpdated, onShowToast }) {
  ...
  const getStatusBadge = (status) => {
    const styles = {
      ...
      SEATED: 'bg-[#c9975b] text-white border-[#b88749]',
      COMPLETED: 'bg-gray-100 text-gray-700 border-gray-400',
      CANCELLED: 'bg-red-100 text-red-700 border-red-400',
      NO_SHOW: 'bg-orange-100 text-amber-800 border-orange-400'
    };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fadeIn">
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col border-2 border-[#e7d4b8]">
        {/* Header */}
        <div className="px-6 pt-6 pb-5 bg-[#c9975b] border-b-2 border-[#e7d4b8] shadow-sm">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 bg-[#fef7ed]/30">
          {loading ? (
            ...
            <div className="text-center py-16">
              <div className="w-24 h-24 mx-auto mb-4 bg-[#e7d4b8] rounded-full flex items-center justify-center shadow-md">
            ...
            <div className="space-y-3">
              {filteredReservations.map(reservation => {
                ...
                return (
                  <div 
                    key={reservation.id}
                    className="bg-white border-2 border-[#e7d4b8] rounded-2xl p-5 hover:border-[#c9975b] hover:shadow-lg transition-all duration-200"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          <span className="font-black text-lg text-[#8b6f47] bg-[#e7d4b8] px-3 py-1 rounded-lg">#{reservation.id}</span>
                        ...
                        <div className="grid grid-cols-2 gap-x-8 gap-y-2.5 text-sm">
                          <div className="flex items-center gap-2.5 text-[#8b6f47] font-medium">
                            <div className="w-8 h-8 rounded-lg bg-[#e7d4b8] flex items-center justify-center">
                        ...
                        {reservation.ghi_chu && (
                          <div className="mt-3 p-3 bg-[#fef7ed] rounded-lg border border-[#e7d4b8]">
                      ...
                      <div className="flex gap-2 ml-4">
                        {reservation.trang_thai === 'PENDING' && (
                          <>
                            <button
                              ...
                              className="w-10 h-10 bg-green-500 text-white rounded-xl font-bold transition-all border-2 border-green-500 hover:bg-white hover:text-green-500 outline-none focus:outline-none flex items-center justify-center"
                              title="Xác nhận"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                              ...
                              className="w-10 h-10 bg-red-500 text-white rounded-xl font-bold transition-all border-2 border-red-500 hover:bg-white hover:text-red-500 outline-none focus:outline-none flex items-center justify-center"
                              title="Hủy"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {reservation.trang_thai === 'CONFIRMED' && (
                          <>
                            ...
                            <button
                              ...
                              className="w-10 h-10 bg-amber-500 text-white rounded-xl font-bold transition-all border-2 border-amber-500 hover:bg-white hover:text-amber-500 outline-none focus:outline-none flex items-center justify-center"
                              title="No-show"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {reservation.trang_thai === 'SEATED' && (
                          <div className="px-5 py-2.5 bg-[#c9975b] text-white rounded-xl font-bold shadow-sm flex items-center gap-2">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Đang phục vụ
        ...
        {/* Footer */}
        <div className="px-6 py-4 bg-[#fef7ed] border-t-2 border-[#e7d4b8]">
          <button
            onClick={onClose}
            className="w-full py-3.5 px-4 bg-[#c9975b] text-white border-2 border-[#c9975b] rounded-xl font-bold transition-all hover:bg-white hover:text-[#c9975b] outline-none focus:outline-none flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M6 18L18 6M6 6l12 12" />
            </svg>
      ...
      {cancelDialog.open && (
        <>
          ...
          <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 pointer-events-none">
            <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full pointer-events-auto border-2 border-[#e7d4b8] animate-fadeIn">
              ...
              <div className="px-6 py-4 bg-[#fef7ed] border-t-2 border-[#e7d4b8] flex gap-3 rounded-b-3xl">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-red-500 text-white border-2 border-red-500 rounded-xl font-bold transition-all hover:bg-white hover:text-red-500 outline-none focus:outline-none flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
